...
> from GitHub via `git+https://...@<tag>`. Pin to a release tag (e.g. `@v1.2.1`)
...
uv tool install "git+https://github.com/denfry/codebase-index.git@v1.2.1"
...
As of `1.2.1`, this documentation treats GitHub tag installs as the verified
...
[OK] codebase-index package installed (v1.2.1)
...
```bash
pip install "codebase-index[watch] @ git+https://github.com/denfry/codebase-index.git@v1.2.1"
